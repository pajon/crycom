module.exports = {
    debug: true,
    sandbox: false, // N - N contacts
    database:  "mongodb://db:blakladla@ds051368.mongolab.com:51368/crycom",
    client: {
        noop: 10 // seconds
    },
    address: {
