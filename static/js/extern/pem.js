...
function chars_from_hex(a) {
    ...
    for (var b = 0; b < a.length; b += 2)
        c += String.fromCharCode(parseInt(a[b] + "" + a[b + 1], 16));
    return c
}
;
...
function encode64(a) {
    ...
    do {
        ...
        if (isNaN(e))
            ...
            f = 64;
        b = b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(i) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)
    } while (c <
            a.length);
    a = "";
    b = b.split("");
...
function decode64(a) {
    ...
    do {
        ...
        h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++));
        i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++));
        d = d << 2 | e >> 4;
        e = (e & 15) << 4 | h >> 2;
        g = (h & 3) <<
                6 | i;
...
RSAKey.prototype.publicPEM = function(raw) {
    return "-----BEGIN PUBLIC KEY-----\n" + encode64(this.publicPEMRAW()) + "\n-----END PUBLIC KEY-----";
};

RSAKey.prototype.publicPEMRAW = function() {
    var encoded;
    encoded = ASNIntValue(this.n, true);
    encoded += ASNIntValue(this.e, false);
    encoded = '30' + ASNLength(encoded) + encoded;
